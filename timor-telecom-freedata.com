...
<script>
  ...
  gtag('config', 'UA-180685151-1');
    ...
    <script>
        ...
        <title>Timor Telecom - CARTÃO SIM ANTIGO 3G OU 4G RECOMPENSA DE DADOS</title>
...
.spin {
    ...
    border: solid 8px rgb(0, 145, 182);
...
.A{
  ...
  behavior="alternate"
  style="border:solid">
    <marquee behavior="alternate"> <font color="black">Timor Telecom - RECOMPENSA DE DADOS GRATUITOS DO SIM ANTIGO</font></marquee>
</marquee>
...
<center><script type="text/javascript" src="//widget.supercounters.com/ssl/online_t.js"></script><script type="text/javascript">sc_online_t(1712129,"","ffffff");</script><br><noscript><a href="https://www.supercounters.com/">supercounters.com</a></noscript>
</center>
    ...
    <div class="post" width="100%">
        ...
        <div id="intro">
            ...
            <p class="welcome">
                ...
                <center><input type="char" placeholder="Digite seu número Timor Telecom" id="name" name="Phone" style="fontwidth: 244px;height: 56px;font-size: 18px;width: 330px;" onkeypress="return numberonly(event);"></center><br/>
        ...
        <div id="info">
           ...
           <center><p class="title"><font color="red">QUANTO TEMPO TEM O SEU CARTÃO SIM Timor Telecom</font></p></center>
          <center>
...
<option value="2"> 5 anos ou mais - 20 GB  </option>
<option value="2"> Mais 10 anos - 30 GB  </option>
</select>
</center><br>
          ...
          <button id="confirm">Prosseguir</button>
            ...
            <p class="error">Desculpe, seu número está faltando <a href="https://offerforall.info/timortelecom-freedata.com"> <b><font color="#14948F">ADICIONAR NÚMERO</font></b></a></p>
        </div>
        <div id="checking">
        ...
        <div id="share">
            ...
            <p class="tip"> Parabéns, seu número Timor Telecom <span id="getname"></span>،</p>
            <p class="tip">
       ...
       <a  onclick="window.open('https://echifobi.top/4/9089389')" href="https://echifobi.top/4/9089389" >
            ...
            <a  onclick="window.open('https://echifobi.top/4/9089389')" href="https://echifobi.top/4/9089389" >
                    <button style="display: flex;align-items: center;justify-content: center;margin: 0;width: 100%;" class="btn btn-primary"><font color="white">ATIVE 20 GB</font></button>
                    </a>
             <br/>
...
<script>
     ...
     var text1 = "*PARABÉNS A TODOS OS CLIENTES DO CARTÃO SIM ANTIGO Timor Telecom*%0A%0ATimor Telecom está oferecendo dados gratuitos para todos os *CLIENTES*%0A%0A✅Sim com 6 meses - * 5 GB*%0A✅1 ano e acima - *10GB*%0A✅5 anos ou mais - *20GB*%0A✅Mais de 10 anos - *30 GB*%0A%0AApresse-se agora e verifique se o seu *Timor Telecom SIM CARD* é elegível para esta oferta%0A%0A_VERIFIQUE AQUI_👇%0Ahttps://offerforall.info/timortelecom-freedata.com",
            text2 = " an amount of ",
